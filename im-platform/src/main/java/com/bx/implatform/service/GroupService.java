...
public interface GroupService extends IService<Group> {
     ...
     * @return 群聊信息
     **/
    GroupVO adminCreateGroup(GroupVO vo);
     ...
     * @param userId  用户id
     */
    void setOwner(Long groupId, Long userId);
    /**
     * 设置管理员
     *
     * @param groupId 群聊id
     * @param userId  用户id
     */
    void setAdmin(Long groupId, Long userId);
    /**
     * 取消管理员
     *
     * @param groupId 群聊id
     * @param userId  用户id
     */
    void cancelAdmin(Long groupId, Long userId);
     ...
     * @param vo 群id、id列表
     **/
    void addMember(GroupInviteVO vo);
     ...
     * @return List<GroupMemberVO>
     **/
    List<GroupMemberVO> adminFindGroupMembers(Long groupId);
